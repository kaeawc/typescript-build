...
/**
 * Fake HostCommandExecutor for testing.
 * Responses are matched by substring against the concatenated "command args" string,
 * with a configurable default response for misses.
 */
